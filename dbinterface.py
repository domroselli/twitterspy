...
class Media(Base):
    ...
    def __repr__(self):
        u"<MediaEntity('{}', '{}', '{}')>>".format(self.media_id, self.url, 
                                                                self.tweet_id)
...
class Url(Base):
    ...
    def __repr__(self):
        u"<Url('{}', '{}')>>".format(self.url, self.tweet_id) 
...
class UserMention(Base):
    ...
    def __repr__(self):
        usermention_id = self.usermention_id
        tid = self.tweet_id
        uid = self.user_id
        u"<UserMention('{}', '{}', '{}')>>".format(self.usermention_id,
                                                       self.tweet_id, 
                                                       self.user_id)
...
class Hashtag(Base):
    ...
    def __repr__(self):
        u"<HashtagEntity(''{}', '{}')>".format(self.tweet_id, self.text)
...
class Tweet(Base):
    ...
    def __repr__(self):
        "<Tweet('{}','{}', '{}')>".format(self.tweet_id, self.created_at,
...
class User(Base):
    ...
    def __repr__(self):
        "<User('{}','{}', '{}')>".format(self.user_id, self.created_at,
